...
(function (root) {
  ...
  function initRegistry(opts) {
    ...
    var SORTS = ["name", "segment", "country", "mtow", "range", "endur", "payload", "ceiling", "cov", "tier"];
    var NUMERIC = { mtow: 1, range: 1, endur: 1, payload: 1, ceiling: 1, cov: 1, tier: 1 };   // sorted as numbers, null-last
    var SORT_LABELS = {
      ...
      ceiling: { en: "Sort: ceiling", vn: "Sắp: trần bay" },
