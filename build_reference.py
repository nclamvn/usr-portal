...
SPARK_SPECS = [("mtow_kg", "mtow", "MTOW", "MTOW"),
               ...
               ("service_ceiling_m", "ceiling", "Ceiling", "Trần bay")]
...
def spec_table_head():
    ...
    return (
        ...
        + head_cell("ceiling", "Ceiling", "Trần bay", "ih-col")
...
def render_row(e, labels, rng, rel=""):
    ...
    return (
        ...
        f'data-payload="{svals["payload"]}" data-ceiling="{svals["ceiling"]}" '
...
def render_facets(ents, labels):
    ...
    quick = (
        ...
        f'data-ph-en="maker / model…" data-ph-vn="hãng / mẫu…">'
