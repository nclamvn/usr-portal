...
CITY_COORD = {
    ...
    # rank 103+ long tail (HQ enrichment to full registry coverage)
    "Atlanta, Georgia": (33.75, -84.39), "Austin, Texas": (30.27, -97.74), "Bandung": (-6.91, 107.61),
    "Bengaluru": (12.97, 77.59), "Boston, Massachusetts": (42.36, -71.06), "Brooklyn, New York": (40.65, -73.95),
    "Camarillo, California": (34.22, -119.04), "Changsha, Hunan": (28.23, 112.94),
    "Chennai, Tamil Nadu": (13.08, 80.27), "Cheseaux-sur-Lausanne": (46.58, 6.60),
    "Concord, California": (37.98, -122.03), "Dallas, Texas": (32.78, -96.80),
    "Dania Beach, Florida": (26.05, -80.14), "Daytona Beach, Florida": (29.21, -81.02), "Dnipro": (48.46, 35.04),
    "Duivendrecht": (52.33, 4.93), "Dusseldorf": (51.23, 6.78), "El Segundo, California": (33.92, -118.42),
    "Hefei, Anhui": (31.82, 117.23), "Huntsville, Alabama": (34.73, -86.59), "Irvine, California": (33.68, -117.83),
    "Iwata, Shizuoka": (34.72, 137.85), "Lexington Park, Maryland": (38.27, -76.45), "Linköping": (58.41, 15.62),
    "Melbourne": (-37.81, 144.96), "Melbourne, Florida": (28.08, -80.61), "Modi'in": (31.90, 35.01),
    "Monaco": (43.74, 7.42), "Moscow": (55.76, 37.62), "Mountain View, California": (37.39, -122.08),
    "Munich": (48.14, 11.58), "Nagoya": (35.18, 136.91), "Nanchang, Jiangxi": (28.68, 115.86),
    "Nanjing, Jiangsu": (32.06, 118.80), "Navi Mumbai": (19.03, 73.03), "New Delhi": (28.61, 77.21),
    "Noida, Uttar Pradesh": (28.54, 77.39), "Pathum Thani": (14.02, 100.53), "Redwood City, California": (37.49, -122.24),
    "Rybinsk": (58.05, 38.84), "Sacheon": (35.00, 128.06), "San Juan, Puerto Rico": (18.47, -66.11),
    "San Leandro, California": (37.72, -122.16), "Sandnes": (58.85, 5.74), "Santa Ana, California": (33.75, -117.87),
    "Santa Cruz, California": (36.97, -122.03), "Singapore": (1.35, 103.82), "Sofia": (42.70, 23.32),
    "Sterling, Virginia": (39.01, -77.43), "Stockholm": (59.33, 18.07), "Stovring": (56.89, 9.84),
    "Tel Aviv": (32.08, 34.78), "Vienna": (48.21, 16.37), "Viimsi": (59.50, 24.83), "Visp": (46.29, 7.88),
    "Weiterstadt": (49.90, 8.59), "Wessling": (48.07, 11.25), "Woburn, Massachusetts": (42.48, -71.15),
    "Xi'an, Shaanxi": (34.34, 108.94), "Yongin": (37.24, 127.18), "Zhuhai, Guangdong": (22.27, 113.58),
    "Zurich": (47.37, 8.54),
}
