...
def render_detail(e, labels):
    ...
    # provenance_class is entity metadata (top-level string) — a plain row, no evidence cell
...
<style>
  .wrap{{max-width:820px;margin:0 auto;padding:1.6rem 1.4rem 3rem}}
...
<main class="wrap">
  ...
  <header class="dhead reg-frame" data-audit="dhead">
  ...
  <p class="note">{bilingual(
    "Every value above traces to a cited source and tier (A manufacturer · B official retailer · C aggregator). "
