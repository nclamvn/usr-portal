...
Trong bản đăng ký USR, 2.827 trường dữ liệu đã được kiểm chứng trong khi chỉ 6 trường đang ở trạng thái tranh chấp.
...
Phần lớn giá trị đã có nguồn xác định, với 2.827 trường mang trạng thái đã kiểm. Bên cạnh đó là 267 trường suy ra từ phân loại nội bộ và 37 trường chưa kiểm, hai nhóm được tách riêng để người đọc không nhầm với phần đã xác nhận.
