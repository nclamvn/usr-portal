...
Khoảng cách giữa các trường là điều rõ nhất. Trọng lượng cất cánh tối đa được điền cho 194 trên 302 thiết bị, trong khi khả năng mã hoá chỉ có ở 3 trên 302. Giữa hai cực đó, các trường như tầm bay, tải trọng và trần bay được điền ở mức trung bình. Mỗi ô để trống là một giá trị honest-null, tức đã xác nhận là chưa thu thập được, chứ không phải một con số phỏng đoán điền cho đầy.
...
Bù lại cho độ phủ không đều là chất lượng nguồn. Trong toàn bộ ô đã điền, có 1.843 giá trị đến từ nguồn mức A, tức kênh chính thức của nhà sản xuất, cao hơn hẳn số đến từ nguồn thứ cấp hay trang tổng hợp. Cách đọc đúng vì vậy là sàn tin cậy đứng cao trong khi độ đầy còn thấp, một trạng thái mà bản đăng ký chọn phơi ra thay vì che.

Vì những lý do trên, mọi tỷ lệ độ phủ trong bài cần được giữ trong khung mẫu tuyển chọn. Con số như 194 trên 302 mô tả đúng bản đăng ký tại thời điểm dựng, song không nói lên mức công bố thông số của toàn ngành UAV; mỗi giá trị đều truy được về nguồn để người dùng tự kiểm.
